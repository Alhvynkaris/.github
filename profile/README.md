...
Our main repositories are [Project Alhvynkaris](https://github.com/Alhvynkaris/Project-Alhvynkaris) itself, and our image/audio/other-large-files [Assets](https://github.com/Alhvynkaris/Assets) repository.
...
To get started, simply clone the [main repository](https://github.com/Alhvynkaris/Project-Alhvynkaris), run Obsidian on it, and start writing! Since you're here, you probably know how to use `git`, but just in case this project gets so big that non-git users get into it, feel free to ask around the Discord server for help.

If you want to get verified for push requests and send us every picture of your pet cat(s), visit our Discord at [MAKE THE SERVER, WILT!!!!]

In the project’s current state, the repositories are generally closed off while I (wilt_r) write in the initial premise and structure. Once its done, you can help contribute to solve plot holes, add more features, and maybe, just maybe, we can figure out geojson together like real gis technicians >:O
